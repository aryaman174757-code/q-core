  ...
  return (
    <div className="glass-panel p-6 sm:p-8 rounded-3xl border border-white/15 space-y-6">
        ...
        <div className="flex flex-wrap items-center gap-1.5">
          <button
            ...
            className={`px-2.5 py-1 rounded-lg text-xs font-mono font-bold transition-all ${
              theta === 0 ? "bg-[#00E5FF] text-black" : "bg-white/5 border border-white/10 text-white"
            }`}
          >
            |0⟩ Ground
          </button>
          <button
            ...
            className={`px-2.5 py-1 rounded-lg text-xs font-mono font-bold transition-all ${
              theta === Math.PI ? "bg-[#7C4DFF] text-white" : "bg-white/5 border border-white/10 text-white"
            }`}
          >
            |1⟩ Excited
          </button>
          <button
            ...
            className={`px-2.5 py-1 rounded-lg text-xs font-mono font-bold transition-all ${
              theta === Math.PI / 2 && phi === 0 ? "bg-white text-black" : "bg-white/5 border border-white/10 text-white"
            }`}
          >
            |+⟩ Superposition
          </button>
          <button
            ...
            className={`px-2.5 py-1 rounded-lg text-xs font-mono font-bold transition-all ${
              theta === Math.PI / 2 && phi === Math.PI / 2 ? "bg-[#22C55E] text-black" : "bg-white/5 border border-white/10 text-white"
            }`}
          >
            |i⟩ Phase State
          </button>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
        {/* 3D Canvas */}
        <div className="lg:col-span-7 h-[420px] rounded-3xl glass-panel border border-white/10 relative overflow-hidden bg-[#050B18]/90">
        ...
        <div className="lg:col-span-5 space-y-5">
          ...
          <div className="p-4 rounded-2xl bg-[#050B18]/80 border border-white/15 space-y-2">
            <span className="text-[10px] font-['Orbitron'] font-bold text-[#7C4DFF] uppercase tracking-wider block">
              Live State Equation: |ψ⟩ = α|0⟩ + β|1⟩
            </span>
            <div className="p-3 rounded-xl bg-black/60 font-mono text-xs sm:text-sm text-white tracking-wide border border-white/5 glow-purple">
              |ψ⟩ = <span className="text-[#00E5FF] font-bold">{alphaVal}</span>|0⟩ +{" "}
          ...
          <div className="space-y-4">
            <div className="space-y-1.5">
              <div className="flex justify-between text-xs font-mono">
                <span className="text-white">Polar Angle θ (Superposition Weight):</span>
            ...
            <div className="space-y-1.5">
              <div className="flex justify-between text-xs font-mono">
                <span className="text-white">Azimuthal Phase φ (Quantum Phase):</span>
                <span className="text-[#7C4DFF] font-bold">
          ...
          <div className="space-y-3 pt-2">
            <div className="space-y-1">
              <div className="flex justify-between text-xs font-mono">
                <span className="text-[#00E5FF] font-bold">P(|0⟩) = |α|²:</span>
                <span className="font-bold text-white">{(prob0 * 100).toFixed(1)}%</span>
              </div>
              <div className="h-3 rounded-full bg-white/10 overflow-hidden">
                <div
                  className="h-full bg-gradient-to-r from-[#00E5FF] to-[#38BDF8] transition-all duration-150"
            ...
            <div className="space-y-1">
              <div className="flex justify-between text-xs font-mono">
                <span className="text-[#7C4DFF] font-bold">P(|1⟩) = |β|²:</span>
                <span className="font-bold text-white">{(prob1 * 100).toFixed(1)}%</span>
              </div>
              <div className="h-3 rounded-full bg-white/10 overflow-hidden">
                <div
                  className="h-full bg-gradient-to-r from-[#7C4DFF] to-[#A855F7] transition-all duration-150"
          ...
          <div className="pt-2 flex items-center gap-3">
            <button
              ...
              className="flex-1 py-3 px-4 rounded-xl bg-gradient-to-r from-[#7C4DFF] to-[#00E5FF] text-[#050B18] font-bold text-xs sm:text-sm font-['Orbitron'] flex items-center justify-center gap-2 hover:opacity-90 shadow-lg glow-purple transition-all active:scale-95 disabled:opacity-50"
            >
            ...
            {measurementResult !== null && (
              <div className="px-4 py-3 rounded-xl bg-white/10 border border-white/20 text-center">
                <span className="text-[10px] text-[#94A3B8] block uppercase font-mono">Output</span>
